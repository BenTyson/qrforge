...
const PLATFORM_CONFIG: Record<string, { name: string; baseUrl: string; color: string; icon: ReactNode }> = {
  twitter: {
    name: 'Twitter / X',
    ...
    >
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          {content.bio && (
            <p className="text-slate-300 mt-2 max-w-sm mx-auto">{content.bio}</p>
          )}
        </div>
