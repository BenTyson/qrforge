          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border/50">
                ...
                <th className="hidden md:table-cell px-6 py-4 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Content</th>
                ...
                <th className="hidden md:table-cell px-6 py-4 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Created</th>
