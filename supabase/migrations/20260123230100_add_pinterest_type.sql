-- Add 'pinterest' to the qr_codes content_type check constraint
-- This allows storing Pinterest profile QR codes in the database

-- Drop the existing constraint
ALTER TABLE qr_codes DROP CONSTRAINT IF EXISTS qr_codes_content_type_check;

-- Add the updated constraint with 'pinterest' included
