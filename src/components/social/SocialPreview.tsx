...
const PLATFORM_CONFIG: Record<string, { name: string; color: string; icon: ReactNode }> = {
  twitter: {
    name: 'X',
    color: '#000000',
    icon: (
...
export function SocialPreview({ content, className }: SocialPreviewProps) {
        ...
        >
          ...
          <div className="p-5 pt-10">
            ...
            <div className="text-center mb-5">
              ...
              {content.bio && (
                <p className="text-[10px] text-slate-400 mt-1 line-clamp-2">{content.bio}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              {links.length === 0 ? (
                <div className="text-center py-6">
                  <p className="text-xs text-slate-500">Add social profiles to see preview</p>
                </div>
              ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[11px] font-medium text-white">{platform.name}</p>
